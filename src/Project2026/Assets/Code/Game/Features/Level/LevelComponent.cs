...
namespace Code.Game.Features.Level
{
    ...
    [Game] public class DefenseFlowFields : IComponent { public Dictionary<Vector2Int, Dictionary<Vector3Int, Vector3Int>> Value; }
    [Game] public class DefenseIntegrationFields : IComponent { public Dictionary<Vector2Int, Dictionary<Vector3Int, int>> Value; }
