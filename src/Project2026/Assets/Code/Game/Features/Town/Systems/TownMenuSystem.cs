...
{
    public class TownMenuSystem : ReactiveSystem<InputEntity>
    {
        private readonly IGroup<MetaEntity> _townMenu;

        public TownMenuSystem() : base(Contexts.sharedInstance.input)
        {
            //_townMenu = Contexts.sharedInstance.meta.GetGroup(MetaMatcher.TownMenu);
        }
        ...
        {
            var menuEntity = _townMenu.GetSingleEntity();
