...
public partial class InputEntity {
    ...
    public Code.Game.Input.AxisInput axisInput { get { return (Code.Game.Input.AxisInput)GetComponent(InputComponentsLookup.AxisInput); } }
    ...
    public void AddAxisInput(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Game.Input.AxisInput)CreateComponent(index, typeof(Code.Game.Input.AxisInput));
