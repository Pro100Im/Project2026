...
public partial class GameEntity {
    ...
    public Code.Game.Features.Movement.MovementSpeed movementSpeed { get { return (Code.Game.Features.Movement.MovementSpeed)GetComponent(GameComponentsLookup.MovementSpeed); } }
    ...
    public void AddMovementSpeed(float newValue) {
        ...
        var component = (Code.Game.Features.Movement.MovementSpeed)CreateComponent(index, typeof(Code.Game.Features.Movement.MovementSpeed));
