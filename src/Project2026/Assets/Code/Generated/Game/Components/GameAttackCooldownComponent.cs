...
public partial class GameEntity {
    ...
    public Code.Game.Features.Attack.AttackCooldown attackCooldown { get { return (Code.Game.Features.Attack.AttackCooldown)GetComponent(GameComponentsLookup.AttackCooldown); } }
    ...
    public void AddAttackCooldown(float newValue) {
        ...
        var component = (Code.Game.Features.Attack.AttackCooldown)CreateComponent(index, typeof(Code.Game.Features.Attack.AttackCooldown));
